...
/*
  12-voice polyphonic MIDI synth for ESP32Synth
  - 2 selectable waveforms (CC 20)
  - Per-voice ADSR
  - LFO vibrato (CC 21 rate, CC 22 depth)
  - Glide/portamento (CC 5)
  - MIDI input via DIN/USB-Serial at 31250 baud
*/
